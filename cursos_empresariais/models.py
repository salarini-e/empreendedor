...
class Curso(models.Model):
    ...
    user_inclusao = models.ForeignKey(User, on_delete=models.CASCADE, related_name='curso_user_inclusao_empresarial')
    user_ultima_alteracao = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='curso_user_ultima_alteracao_empresarial', null=True, blank=True)
...
class Turma(models.Model):
    ...
    user_inclusao = models.ForeignKey(
        User, on_delete=models.PROTECT, related_name='turma_user_inclusao_empresarial')
    user_ultima_alteracao = models.ForeignKey(
        User, on_delete=models.PROTECT, related_name='turma_user_ultima_alteracao_empresarial', null=True, blank=True)
